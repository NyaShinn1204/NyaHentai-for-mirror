    ...
    <div class="container_doujin">
        ...
        <div id="container">
            <div id="main">
                ...
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/fanzine/get_post_data?id=' . $id;
                ...
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/fanzine/get_related?id=' . $id;
