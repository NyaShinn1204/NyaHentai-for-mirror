    ...
    <div class="container_doujin">
        ...
        <div id="container">
            <div id="main">
                ...
                function fetchCount()
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/fanzine/get_count';
                ...
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/fanzine/get_doujinshi';
                ...
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/fanzine/get_pagenavi';
