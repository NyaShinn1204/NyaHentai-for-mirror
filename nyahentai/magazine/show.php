...
<body>
    ...
    <div class="container_doujin">
        ...
        <div id="container">
            <div id="main">
                <?php
                function fetchPagenavi($id)
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/magazine/get_post_data?id=' . $id;
                ...
                // APIからデータを取得
                $pagenaviList = fetchPagenavi($book_id);
                echo str_replace("https://nyahentai.re/","https://dev.minohaed.com/doujinshi/nyahentai/",$pagenaviList);
                ?>
                <?php
                function fetchDoujinshi($id)
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/magazine/get_related?id=' . $id;
                ...
                // APIからデータを取得
                $doujinshiList = fetchDoujinshi($book_id);
                ?>
                <div id="list-data">
                    <h3>related</h3>
                    <h1>関連エロ漫画</h1>
