    ...
    <div class="container_doujin">
        ...
        <div id="container">
            <div id="main">
                ...
                function fetchCount()
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/magazine/get_count';
                ...
                // APIからデータを取得
                $doujinshiList = fetchCount();
                ?>
                <div class="page-h">
                    <h3>magazine</h3>
                    <h1>商業誌</h1>
                    <span><?php echo $doujinshiList["count"]; ?></span>
                </div>
                <?php
                function fetchDoujinshi()
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/magazine/get_doujinshi';
                ...
                <?php
                function fetchPagenavi()
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/magazine/get_pagenavi';
