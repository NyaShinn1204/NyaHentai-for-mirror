    ...
    <div class="container_doujin">
        ...
        <div id="container">
            <div id="main">
                ...
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/get_circle?name=' . $name;
                ...
                {
                    $url = 'https://dev.minohaed.com/api/v1/doujinshi/nyahentai/get_circle_list?name=' . $name;
